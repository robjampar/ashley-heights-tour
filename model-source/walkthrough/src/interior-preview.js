...
if($('layout-plan'))$('layout-plan').src=asset(roomConfig.planAsset??'layout-plan.svg');
...
let activeCamera='kitchen',fills,vegetation,ready=false;const cutawayMeshes=[];
