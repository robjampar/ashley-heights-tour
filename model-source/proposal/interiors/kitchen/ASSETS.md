...
Concept images guide appearance; actual wall/window geometry and clear circulation govern furniture placement. The Side garden living room now shares the selected palette as a TV lounge; the separate formal dining bay remains a later room session. TV details, upholstery, plants, vessels and all furnishings are native meshes, not generated room images used as surface overlays. Browser lighting and the native Cycles renderer are different rendering systems, so neither is claimed to reproduce the generated reference pixel for pixel.
