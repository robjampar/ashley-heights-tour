...
for heading,body in [
 ...
 ('River/sea flooding and statutory heritage','The current Environment Agency Flood Zones dataset returns no Zone 2 or 3 polygon within the reconstructed plot plus a 100 m margin, supporting a river/sea Zone 1 map screening. Historic England NHLE mapping shows no listed-building point or polygon on the plot; the nearest is Grade II Vine View, about 269 m away. The present-day and 2070s upper-end surface-water spatial-planning maps also show no mapped extent across the approximate plot. These are area-level screens; local listing, historic curtilage, heritage setting, groundwater and property-specific flood risk remain to be assessed.'),
 ...
 ('Still to establish','Local-list status, groundwater, sewer flooding, drainage changes and basement suitability remain unverified. The owner confirms the plot is outside the Green Belt. Existing permission conditions, current legal order coverage, boundaries, ground levels and neighbour windows need their own checks. E1 remains the least extensive alteration of the three complete redesigns, but its planning acceptability is not guaranteed.'),
]:
...
for text,url in [
 ...
 ('Environment Agency: surface-water spatial-planning present day and climate scenarios','https://www.data.gov.uk/dataset/dfd734fb-cc68-4229-b60d-8c0280398052/flood-map-for-planning-surface-water-spatial-planning-extents-present-day'),
