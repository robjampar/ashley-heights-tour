...
for heading,body in [
 ...
 ('Still to establish','Listed and local heritage constraints and all flood sources remain unverified. The owner confirms the plot is outside the Green Belt. Existing permission conditions, current legal order coverage, boundaries, ground levels and neighbour windows need their own checks. E1 remains the least extensive alteration of the three complete redesigns, but its planning acceptability is not guaranteed.'),
]:
