...
for id in ('i1','i2','i3','e1','e2','e3'):
 for file in ('build-report.json','circulation-audit.json','private-access-audit.json','ensuite-access-audit.json','stairs-navigation-audit.json','stair-headroom-audit.json','parking-audit.json','pool-navigation-audit.json','site-clearance-audit.json','garage-access-audit.json'):
