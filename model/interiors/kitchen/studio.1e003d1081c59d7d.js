const assets={"images/01-planning.png": "images/01-planning.da95d4f435a5ebe2.png", "images/01-proposed 2.png": "images/01-proposed 2.be41d91f468c9f6f.png", "images/01-proposed.png": "images/01-proposed.be41d91f468c9f6f.png", "images/02-planning.png": "images/02-planning.a514195fa6afad19.png", "images/02-proposed.png": "images/02-proposed.668f481870a929f9.png", "images/03-planning 2.png": "images/03-planning 2.d4bbf18207440144.png", "images/03-planning 3.png": "images/03-planning 3.d4bbf18207440144.png", "images/03-planning.png": "images/03-planning.d4bbf18207440144.png", "images/03-proposed 2.png": "images/03-proposed 2.c8061b9c109ef68a.png", "images/03-proposed.png": "images/03-proposed.c8061b9c109ef68a.png", "images/04-planning 2.png": "images/04-planning 2.32e6cf675f158f8c.png", "images/04-planning.png": "images/04-planning.32e6cf675f158f8c.png", "images/04-proposed.png": "images/04-proposed.6eb2b00b81b97439.png", "images/05-planning.png": "images/05-planning.fe804c82f5e9ec18.png", "images/05-proposed 2.png": "images/05-proposed 2.a6695788b03853cf.png", "images/05-proposed.png": "images/05-proposed.a6695788b03853cf.png", "images/06-planning 2.png": "images/06-planning 2.97d0bf421f9e8c3e.png", "images/06-planning.png": "images/06-planning.97d0bf421f9e8c3e.png", "images/06-proposed 2.png": "images/06-proposed 2.91067e244492cd57.png", "images/06-proposed.png": "images/06-proposed.91067e244492cd57.png", "images/07-planning 2.png": "images/07-planning 2.d059fa705ff52ad7.png", "images/07-planning 3.png": "images/07-planning 3.d059fa705ff52ad7.png", "images/07-planning.png": "images/07-planning.d059fa705ff52ad7.png", "images/07-proposed 2.png": "images/07-proposed 2.4dd418116911b6b2.png", "images/07-proposed.png": "images/07-proposed.4dd418116911b6b2.png", "images/08-planning 2.png": "images/08-planning 2.2a3095d7c84c6894.png", "images/08-planning.png": "images/08-planning.2a3095d7c84c6894.png", "images/08-proposed 2.png": "images/08-proposed 2.dca1500c8ade3edd.png", "images/08-proposed.png": "images/08-proposed.dca1500c8ade3edd.png", "images/09-planning.png": "images/09-planning.eccbc74c710f1199.png", "images/09-proposed 2.png": "images/09-proposed 2.db6515f016c7815c.png", "images/09-proposed.png": "images/09-proposed.db6515f016c7815c.png", "images/10-planning.png": "images/10-planning.49ddd69bc62ba8fd.png", "images/10-proposed.png": "images/10-proposed.25dfdf1c072a396e.png", "models/compact-kitchen 2.glb": "models/compact-kitchen 2.1ccb341db3334c00.glb", "models/compact-kitchen 2.json": "models/compact-kitchen 2.e0bebf722dba119b.json", "models/compact-kitchen.glb": "models/compact-kitchen.514b0c03834ca395.glb", "models/compact-kitchen.json": "models/compact-kitchen.cf5f2fea2c85ed66.json", "models/compact-render.png": "models/compact-render.417c088c3798e2a4.png", "models/planning-kitchen 2.glb": "models/planning-kitchen 2.0143abbecdb02fb0.glb", "models/planning-kitchen 2.json": "models/planning-kitchen 2.07c429a32de81cde.json", "models/planning-kitchen.glb": "models/planning-kitchen.3405210be21c9fa4.glb", "models/planning-kitchen.json": "models/planning-kitchen.07c429a32de81cde.json", "models/planning-render.png": "models/planning-render.856bf54ca29abe43.png", "options 2.json": "options 2.4827b8f804e259a7.json", "options.json": "options.4827b8f804e259a7.json", "prompts 2.json": "prompts 2.1d9ca2ba962169d1.json", "prompts 3.json": "prompts 3.1d9ca2ba962169d1.json", "prompts.json": "prompts.1d9ca2ba962169d1.json", "references/planning-dining 2.png": "references/planning-dining 2.5553f555fe479ffb.png", "references/planning-dining 3.png": "references/planning-dining 3.5553f555fe479ffb.png", "references/planning-dining.png": "references/planning-dining.5553f555fe479ffb.png", "references/planning-dining.png 2.json": "references/planning-dining.png 2.829cff63b09abd82.json", "references/planning-dining.png 3.json": "references/planning-dining.png 3.829cff63b09abd82.json", "references/planning-dining.png.json": "references/planning-dining.png.829cff63b09abd82.json", "references/planning-kitchen 2.png": "references/planning-kitchen 2.fd6b47635e45b032.png", "references/planning-kitchen 3.png": "references/planning-kitchen 3.fd6b47635e45b032.png", "references/planning-kitchen-reverse 2.png": "references/planning-kitchen-reverse 2.43089d87e24ff853.png", "references/planning-kitchen-reverse 3.png": "references/planning-kitchen-reverse 3.43089d87e24ff853.png", "references/planning-kitchen-reverse.png": "references/planning-kitchen-reverse.43089d87e24ff853.png", "references/planning-kitchen-reverse.png 2.json": "references/planning-kitchen-reverse.png 2.e298a068bf3fc9c1.json", "references/planning-kitchen-reverse.png 3.json": "references/planning-kitchen-reverse.png 3.e298a068bf3fc9c1.json", "references/planning-kitchen-reverse.png.json": "references/planning-kitchen-reverse.png.e298a068bf3fc9c1.json", "references/planning-kitchen.png": "references/planning-kitchen.fd6b47635e45b032.png", "references/planning-kitchen.png 2.json": "references/planning-kitchen.png 2.367259ce309f32c6.json", "references/planning-kitchen.png 3.json": "references/planning-kitchen.png 3.367259ce309f32c6.json", "references/planning-kitchen.png.json": "references/planning-kitchen.png.367259ce309f32c6.json", "references/proposed-dining 2.png": "references/proposed-dining 2.5335036903e6bdfa.png", "references/proposed-dining.png": "references/proposed-dining.5335036903e6bdfa.png", "references/proposed-dining.png 2.json": "references/proposed-dining.png 2.29495e3629313e44.json", "references/proposed-dining.png.json": "references/proposed-dining.png.29495e3629313e44.json", "references/proposed-kitchen 2.png": "references/proposed-kitchen 2.b170925cee0c06db.png", "references/proposed-kitchen-reverse 2.png": "references/proposed-kitchen-reverse 2.0c6c32f2f81d8ae4.png", "references/proposed-kitchen-reverse 3.png": "references/proposed-kitchen-reverse 3.0c6c32f2f81d8ae4.png", "references/proposed-kitchen-reverse.png": "references/proposed-kitchen-reverse.0c6c32f2f81d8ae4.png", "references/proposed-kitchen-reverse.png 2.json": "references/proposed-kitchen-reverse.png 2.506ffcbb6f029345.json", "references/proposed-kitchen-reverse.png 3.json": "references/proposed-kitchen-reverse.png 3.506ffcbb6f029345.json", "references/proposed-kitchen-reverse.png.json": "references/proposed-kitchen-reverse.png.506ffcbb6f029345.json", "references/proposed-kitchen.png": "references/proposed-kitchen.b170925cee0c06db.png", "references/proposed-kitchen.png 2.json": "references/proposed-kitchen.png 2.982a4c163a074236.json", "references/proposed-kitchen.png.json": "references/proposed-kitchen.png.982a4c163a074236.json", "room-model.js": "room-model.d06082638e7849ce.js", "studio 2.css": "studio 2.53ef1e5b1b574299.css", "studio 2.js": "studio 2.b0d65c78e20c4042.js", "studio.css": "studio.53ef1e5b1b574299.css"};const asset=path=>assets[path]??path;
...
function hash(){history.replaceState(null,'','#'+option.id+'-'+design);}
